...
const TableNameTabPriceTimeSpring = "tab_price_time_spring"
...
// TableName TabPriceTimeSpring's table name
func (*TabPriceTimeSpring) TableName() string {
	return TableNameTabPriceTimeSpring
}
