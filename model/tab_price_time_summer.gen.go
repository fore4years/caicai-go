...
const TableNameTabPriceTimeSummer = "tab_price_time_summer"
...
// TableName TabPriceTimeSummer's table name
func (*TabPriceTimeSummer) TableName() string {
	return TableNameTabPriceTimeSummer
}
